...
@Component({
  selector: 'app-header-date-picker-intervalo-disp-propiedad',
  templateUrl: './header-picker-intervalo-disp-propiedad.component.html',
  styleUrls: ['./header-picker-intervalo-disp-propiedad.component.css'],
  changeDetection: ChangeDetectionStrategy.OnPush,
})
export class HeaderDatePickerIntervaloDispPropiedadComponent<D>
